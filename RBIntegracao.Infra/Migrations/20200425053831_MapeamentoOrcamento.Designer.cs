...
namespace RBIntegracao.Infra.Migrations
{
    ...
    [Migration("20200425053831_MapeamentoOrcamento")]
    partial class MapeamentoOrcamento
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RBIntegracao.Domain.Entities.Orcamento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("RBIntegracao.Domain.Entities.OrcamentoSolicitacao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("OrcamentoSolicitacao");
                });
            ...
            modelBuilder.Entity("RBIntegracao.Domain.Entities.OrcamentoSolicitacao", b =>
                {
                    b.HasOne("RBIntegracao.Domain.Entities.Orcamento", "Orcamento")
                        .WithMany()
